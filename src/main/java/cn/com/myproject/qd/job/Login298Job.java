 ...
 * @Date: 2019/9/2 15:15
 */
public class Login298Job implements Job {

    private static final Logger logger = LoggerFactory.getLogger(Login298Job.class);
    ...
    public void execute(JobExecutionContext jobExecutionContext) throws JobExecutionException {
        logger.info("执行登录job..............");
        Token.clear();
        Passwd.goodsId298 = new AtomicInteger(-999);
        List<User> list = userService.getAll(1);
        for(User user:list) {
