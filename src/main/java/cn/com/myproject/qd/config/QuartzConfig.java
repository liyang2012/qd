...
public class QuartzConfig {
    ...
    public void init() throws SchedulerException {
        ...
        JobDetail job = JobBuilder.newJob(QdJob.class).withIdentity("q1", "d1").withDescription("上午抢单").build();
        ...
        //type=2
        job = JobBuilder.newJob(LoginJob.class).withIdentity("q2", "d2").withDescription("上午登录").build();
        ...
        trigger = TriggerBuilder.newTrigger().withSchedule(CronScheduleBuilder.cronSchedule("0/3 18,19,20 10,17,20 * * ?")
                .withMisfireHandlingInstructionDoNothing())
        ...
        trigger = TriggerBuilder.newTrigger().withSchedule(CronScheduleBuilder.cronSchedule("0/5 * * * * ?")
                .withMisfireHandlingInstructionDoNothing())
        ...
        job = JobBuilder.newJob(QdJob.class).withIdentity("q4", "d4").withDescription("下午抢单").build();
        ...
        //type=3
        job = JobBuilder.newJob(Login1Job.class).withIdentity("q5", "d5").withDescription("下午登录").build();
        ...
        trigger = TriggerBuilder.newTrigger().withSchedule(CronScheduleBuilder.cronSchedule("0 13,16 20 * * ?")
                .withMisfireHandlingInstructionDoNothing())
